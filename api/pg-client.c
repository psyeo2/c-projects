...
int main(int argc, char *argv[]) {
    ...
    char *conninfo = "dbname=scout_app user=scout_app_user password=RF31bpMH2l1effxnG55McY368MwtrL0j host=172.16.2.23 port=5432";
    ...
    // Execute a query
    char *query = "SELECT * FROM shadow_users";
